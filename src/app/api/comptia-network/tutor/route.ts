...
const EXAM_ID = "comptia-network";
const EXAM_DISPLAY_NAME = "CompTIA Network+ (N10-009)";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. Respond in English.

Cover networking concepts, infrastructure, network operations, network security, and network troubleshooting. Align to CompTIA Network+ objectives.
