...
export const metadata: Metadata = {
  title: "Pricing — Comptia Network Premium",
  description: "Unlock unlimited Comptia Network practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=comptia-network&cadence=annual`;
