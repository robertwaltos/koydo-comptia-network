// Auto-generated shim — re-exports from @/lib/comptia-network/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _comptia_network_Config } from "@/lib/comptia-network/config";
import { EXAM_CONFIG as _raw } from "@/lib/comptia-network/config";
